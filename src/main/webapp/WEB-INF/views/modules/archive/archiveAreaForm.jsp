...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/archive/archiveArea/">地区分类列表</a></li>
		<li class="active"><a href="${ctx}/archive/archiveArea/form?id=${archiveArea.id}">地区分类<shiro:hasPermission name="archive:archiveArea:edit">${not empty archiveArea.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="archive:archiveArea:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="archiveArea" action="${ctx}/archive/archiveArea/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="archive:archiveArea:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
