...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/purchase/contractPurchaseStorageDetail/">采购入库明细列表</a></li>
		<li class="active"><a href="${ctx}/purchase/contractPurchaseStorageDetail/form?id=${contractPurchaseStorageDetail.id}">采购入库明细<shiro:hasPermission name="purchase:contractPurchaseStorageDetail:edit">${not empty contractPurchaseStorageDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="purchase:contractPurchaseStorageDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="contractPurchaseStorageDetail" action="${ctx}/purchase/contractPurchaseStorageDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">入库单号：</label>
			<div class="controls">
				<form:input path="storageCode" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
		...
		<div class="control-group">
			<label class="control-label">结算数量：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">结算单价：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">入库原始金额：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">入库原始数量：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">入库原始单价：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">入库皮重：</label>
			<div class="controls">
				<form:input path="originItemTare" htmlEscape="false" maxlength="20" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">入库毛重：</label>
			<div class="controls">
				<form:input path="originItemGross" htmlEscape="false" maxlength="20" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="supplierCode" htmlEscape="false" maxlength="16" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="supplierName" htmlEscape="false" maxlength="60" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="salemanCode" htmlEscape="false" maxlength="20" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">采购员名称：</label>
			<div class="controls">
				<form:input path="salemanName" htmlEscape="false" maxlength="20" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="purchase:contractPurchaseStorageDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
