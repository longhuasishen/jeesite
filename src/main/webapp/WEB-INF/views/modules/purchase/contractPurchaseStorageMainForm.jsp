...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/purchase/contractPurchaseStorageMain/">采购入库列表</a></li>
		<li class="active"><a href="${ctx}/purchase/contractPurchaseStorageMain/form?id=${contractPurchaseStorageMain.id}">采购入库<shiro:hasPermission name="purchase:contractPurchaseStorageMain:edit">${not empty contractPurchaseStorageMain.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="purchase:contractPurchaseStorageMain:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="contractPurchaseStorageMain" action="${ctx}/purchase/contractPurchaseStorageMain/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<div id="myTabContent" class="tab-content">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="storageType" htmlEscape="false" maxlength="20" class="input-xlarge required" value="采购入库" readonly="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="tab-pane fade" id="persons">
			...
			<script type="text/javascript">
                ...
                $(document).ready(function () {
                    $("#jqGrid").jqGrid({
                        url: '${ctx}/purchase/contractPurchaseStorageDetail/listJson?storageCode=${contractPurchaseStorageMain.storageCode}',
                        editurl: 'clientArray',
                        mtype: "GET",
                        datatype: "json",
                        page: 1,
...
//                            grid.jqGrid('saveRow',id,{url:'clientArray'});
                    ...
                    $('#jqGrid').setGroupHeaders(
                        {
                            ...
                            groupHeaders: [
                                { "numberOfColumns": 5, "titleText": "入库情况", "startColumnName": "originItemTare" },
                                { "numberOfColumns": 3, "titleText": "结算情况", "startColumnName": "itemPrice" }]
                        });
                });
		...
		<div class="form-actions">
			<shiro:hasPermission name="purchase:contractPurchaseStorageMain:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
