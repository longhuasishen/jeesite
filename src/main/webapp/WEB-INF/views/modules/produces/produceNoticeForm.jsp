...
<ul class="nav nav-tabs">
	<li><a href="${ctx}/produces/produceDesign/listNotice">生产通知单列表</a></li>
	<li class="active"><a href="${ctx}/produces/produceDesign/formNotice?id=${produceDesign.id}">生产通知单<shiro:hasPermission name="produces:produceNotice:edit">${not empty produceDesign.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="produces:produceNotice:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="produceDesign" action="${ctx}/produces/produceDesign/saveNotice" method="post" class="form-horizontal">
	<form:hidden path="id"/>
	...
	<div class="form-actions">
		<shiro:hasPermission name="produces:produceNotice:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
