...
<form:form id="inputForm" modelAttribute="docBeton" action="${ctx}/doc/docBeton/save" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<sys:treeselect id="kindCategory" name="archiveMaterial.id" value="${docBeton.archiveMaterial.id}" labelName="archiveMaterial.materialName" labelValue="${docBeton.archiveMaterial.materialName}"
	...
	<div class="control-group">
		...
		<div class="controls">
			<sys:treeselect id="kindType" name="docConcretetyp.id" value="${docBeton.docConcretetyp.id}" labelName="docConcretetyp.concretetypName" labelValue="${docBeton.docConcretetyp.concretetypName}"
	...
	<div class="control-group">
		...
		<div class="controls">
			<sys:treeselect id="primaryProvider" name="docSupplier.id"  value="${docBeton.docSupplier.id}" labelName="docSupplier.supName" labelValue="${docBeton.docSupplier.supName}"
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:checkboxes path="childBetonList1" items="${fns:getDictList('concrete_box1')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
		</div>
	</div>
	<!-- <div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:checkboxes path="childBetonList2" items="${fns:getDictList('concrete_box2')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
		</div>
	</div>
	<!--<div class="control-group">
