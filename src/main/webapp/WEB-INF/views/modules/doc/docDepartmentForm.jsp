...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/doc/docDepartment/">部门档案列表</a></li>
		<li class="active"><a href="${ctx}/doc/docDepartment/form?id=${docDepartment.id}">部门档案<shiro:hasPermission name="doc:docDepartment:edit">${not empty docDepartment.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="doc:docDepartment:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docDepartment" action="${ctx}/doc/docDepartment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">部门编码：</label>
			<div class="controls">
				<form:input path="departmentCode" htmlEscape="false" maxlength="16" class="input-xlarge required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="doc:docDepartment:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
