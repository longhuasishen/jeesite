...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/doc/docStation/">搅拌站档案列表</a></li>
		<li class="active"><a href="${ctx}/doc/docStation/form?id=${docStation.id}">搅拌站档案<shiro:hasPermission name="doc:docStation:edit">${not empty docStation.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="doc:docStation:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docStation" action="${ctx}/doc/docStation/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">搅拌站编码：</label>
			<div class="controls">
				<form:input path="stationCode" htmlEscape="false" maxlength="16" class="input-xlarge required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="doc:docStation:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
