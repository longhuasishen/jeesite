...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/doc/docWatermeth/">浇灌方式档案列表</a></li>
		<li class="active"><a href="${ctx}/doc/docWatermeth/form?id=${docWatermeth.id}">浇灌方式档案<shiro:hasPermission name="doc:docWatermeth:edit">${not empty docWatermeth.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="doc:docWatermeth:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docWatermeth" action="${ctx}/doc/docWatermeth/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="watermethName" htmlEscape="false" maxlength="120" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="doc:docWatermeth:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
