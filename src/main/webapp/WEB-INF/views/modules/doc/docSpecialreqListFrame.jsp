...
<body>
	...
	<form:form id="searchForm" modelAttribute="docSpecialreq" action="${ctx}/doc/docSpecialreq/listFrame" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="docSpecialreq">
			<tr onclick="getTableRowData(this)">
				<td>${docSpecialreq.specialreqCode}</td>
				<td>${docSpecialreq.specialreqName}</td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
