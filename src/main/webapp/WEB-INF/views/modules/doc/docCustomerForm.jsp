...
<body>
	...
	<form:form id="inputForm" modelAttribute="docCustomer" action="${ctx}/doc/docCustomer/save" method="post" class="form-horizontal">
			...
			<div class="tab-pane fade in active" id="home">
				<p>
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="cusName" htmlEscape="false" maxlength="60" class="input-xlarge required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="cusProject" htmlEscape="false" maxlength="120" class="input-xlarge required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
					<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="doc:docCustomer:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
