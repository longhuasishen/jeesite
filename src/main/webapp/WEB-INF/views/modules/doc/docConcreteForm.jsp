...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/doc/docConcrete/">原材料档案列表</a></li>
		<li class="active"><a href="${ctx}/doc/docConcrete/form?id=${docConcrete.id}">原材料档案<shiro:hasPermission name="doc:docConcrete:edit">${not empty docConcrete.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="doc:docConcrete:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docConcrete" action="${ctx}/doc/docConcrete/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="kindCategory" class="input-xlarge ">
		...
		<div class="form-actions">
			<shiro:hasPermission name="doc:docConcrete:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
