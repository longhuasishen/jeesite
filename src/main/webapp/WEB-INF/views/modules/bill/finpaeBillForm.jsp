...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bill/finpaeBill/">财务应收调账单列表</a></li>
		<li class="active"><a href="${ctx}/bill/finpaeBill/form?id=${finpaeBill.id}">财务应收调账单<shiro:hasPermission name="bill:finpaeBill:edit">${not empty finpaeBill.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="bill:finpaeBill:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="finpaeBill" action="${ctx}/bill/finpaeBill/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="customName" name="docCustomer.id" value="${finpaeBill.docCustomer.id}" labelName="docCustomer.cusName" labelValue="${finpaeBill.docCustomer.cusName}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="bill:finpaeBill:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
