...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/financedoc/docInitStorageDetail/">期初入库列表</a></li>
		<li class="active"><a href="${ctx}/financedoc/docInitStorageDetail/form?id=${docInitStorageDetail.id}">期初入库<shiro:hasPermission name="financedoc:docInitStorageDetail:edit">${not empty docInitStorageDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="financedoc:docInitStorageDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docInitStorageDetail" action="${ctx}/financedoc/docInitStorageDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="financedoc:docInitStorageDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
