...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/financedoc/docBusinessInitbalance/">业务应收期初余额列表</a></li>
		<li class="active"><a href="${ctx}/financedoc/docBusinessInitbalance/form?id=${docBusinessInitbalance.id}">业务应收期初余额<shiro:hasPermission name="financedoc:docBusinessInitbalance:edit">${not empty docBusinessInitbalance.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="financedoc:docBusinessInitbalance:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docBusinessInitbalance" action="${ctx}/financedoc/docBusinessInitbalance/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">客户编码：</label>
			<div class="controls">
				<sys:treeselect id="cus_code" name="docCustomer.id" value="${docBusinessInitbalance.docCustomer.id}" labelName="docCustomer.cusCode" labelValue="${docBusinessInitbalance.docCustomer.cusCode}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="financedoc:docBusinessInitbalance:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
