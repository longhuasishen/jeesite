...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/financedoc/docFinanceInitpay/">财务应付期初余额列表</a></li>
		<li class="active"><a href="${ctx}/financedoc/docFinanceInitpay/form?id=${docFinanceInitpay.id}">财务应付期初余额<shiro:hasPermission name="financedoc:docFinanceInitpay:edit">${not empty docFinanceInitpay.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="financedoc:docFinanceInitpay:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="docFinanceInitpay" action="${ctx}/financedoc/docFinanceInitpay/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">供应商编码：</label>
			<div class="controls">
				<sys:treeselect id="sup_code" name="docSupplier.id" value="${docFinanceInitpay.docSupplier.id}" labelName="docSupplier.supCode" labelValue="${docFinanceInitpay.docSupplier.supCode}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="financedoc:docFinanceInitpay:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
