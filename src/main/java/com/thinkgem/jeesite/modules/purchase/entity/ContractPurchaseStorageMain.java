...
@Getter
@Setter
public class ContractPurchaseStorageMain extends DataEntity<ContractPurchaseStorageMain> {
	...
	public ContractPurchaseStorageMain() {
		super();
	}

	public ContractPurchaseStorageMain(String id){
		super(id);
	}
	...
	@Length(min=0, max=20, message="经手人长度必须介于 0 和 20 之间")
