...
@Getter
@Setter
public class ContractPurchaseSupplement extends DataEntity<ContractPurchaseSupplement> {
	...
	public ContractPurchaseSupplement() {
		super();
	}

	public ContractPurchaseSupplement(String id){
		super(id);
	}
