 ...
 * @version 2018-01-15
 */
public class ContractSalesBeton extends DataEntity<ContractSalesBeton> {
	...
	public ContractSalesBeton() {
		super();
	}

	public ContractSalesBeton(String id){
		super(id);
	}
	...
	@Length(min=0, max=16, message="品种编码长度必须介于 0 和 16 之间")
